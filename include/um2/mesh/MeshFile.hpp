...
//#include <um2/common/vector.hpp> // Vector
//#include <um2/common/string.hpp> // String
//#include <um2/geometry/point.hpp> // EPS_POINT
...
//     Vector<I> elset_offsets;        // size = num_elsets + 1
//     Vector<I> elset_ids;            // size = elset_offsets[num_elsets]
//
//     // -- Constructors --
//
//     UM2_HOSTDEV MeshFile() = default;
//
//     // -- Methods --
//
...
//
// template <std::floating_point T, std::signed_integral I>
// UM2_HOSTDEV int compare_geometry(MeshFile<T, I> const & a, MeshFile<T, I> const & b)
//{
//     if (!is_approx(a.nodes_x, b.nodes_x, EPS_POINT<T>)) return 1;
//     if (!is_approx(a.nodes_y, b.nodes_y, EPS_POINT<T>)) return 1;
//     if (!is_approx(a.nodes_z, b.nodes_z, EPS_POINT<T>)) return 1;
//     if (!(a.element_offsets == b.element_offsets)) return 2;
//     if (!(a.element_conn == b.element_conn)) return 2;
//     return 0;
// }
//
// template <std::floating_point T, std::signed_integral I>
