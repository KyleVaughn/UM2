...
//constexpr auto
//validatePolytopeSoupType(MeshType const type) -> bool
//{
...
{
  assert(!soup.vertices.empty());
  assert(!soup.element_conn.empty());
  auto const num_vertices = static_cast<Size>(soup.vertices.size());
  auto const num_faces = static_cast<Size>(soup.numCells());
  auto const conn_size = static_cast<Size>(soup.element_conn.size());
//  MeshType const meshtype = soup.getMeshType();
//  if (!validatePolytopeSoupType<P, N>(meshtype)) {
//    Log::error("Attempted to construct a FaceVertexMesh from a mesh soup with an "
...
//      mesh.vertices[i][0] = soup.vertices[static_cast<size_t>(i)][0];
//      mesh.vertices[i][1] = soup.vertices[static_cast<size_t>(i)][1];
//    }
//  } else {
//    mesh.vertices = soup.vertices;
//  }
//
...
//      mesh.fv[i][j] = soup.element_conn[static_cast<size_t>(idx)];
//    }
//  }
//
...
//    ++vert_counts[static_cast<Size>(soup.element_conn[i])];
//  }
...
//template <Size P, Size N, Size D, std::floating_point T, std::signed_integral I>
//void
//toPolytopeSoup(FaceVertexMesh<P, N, D, T, I> const & mesh, PolytopeSoup<T, I> & file) noexcept
//{
//  // Vertices
//  if constexpr (D == 3) {
...
template <Size P, Size N, Size D, std::floating_point T, std::signed_integral I>
FaceVertexMesh<P, N, D, T, I>::FaceVertexMesh(PolytopeSoup<T, I> const & file)
{
...
//template <Size P, Size N, Size D, std::floating_point T, std::signed_integral I>
//void
//FaceVertexMesh<P, N, D, T, I>::toPolytopeSoup(PolytopeSoup<T, I> & file) const noexcept
//{
//  um2::toPolytopeSoup(*this, file);
//}
//
////==============================================================================
//// getFaceAreas
