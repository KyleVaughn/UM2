...
public:
  ...
  void
  reserveMoreElements(Size num_elems, VTKElemType elem_type);
...
template <std::floating_point T, std::signed_integral I>
void
PolytopeSoup<T, I>::reserveMoreElements(Size const num_elems, VTKElemType const elem_type)
{
  // Element types
  _element_types.reserve(num_elems + _element_types.size());
  _element_types.push_back(num_elems, elem_type);
