...
template <class T>
auto
stringToLattice(String const & str, char const delimiter = ' ') -> Vector<Vector<T>>
{
  ...
  bool const last_line_has_more_values =
      str_view.find_first_not_of(delimiter) == StringView::npos;
