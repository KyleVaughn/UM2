...
template <Int D>
PURE HOSTDEV constexpr auto
QuadraticQuadrilateral<D>::operator()(Float const r,
                                      Float const s) const noexcept -> Point<D>
{
...
template <Int D>
PURE HOSTDEV constexpr auto
jacobian(QuadraticQuadrilateral<D> const & q, Float const r,
...
template <Int D>
PURE HOSTDEV constexpr auto
QuadraticQuadrilateral<D>::jacobian(Float const r,
...
template <Int D>
PURE HOSTDEV constexpr auto
QuadraticQuadrilateral<D>::isCCW() const noexcept -> bool
  requires(D == 2)
{
...
template <Int D>
PURE HOSTDEV constexpr auto
QuadraticQuadrilateral<D>::contains(Point2 p) const noexcept -> bool
  requires(D == 2)
{
...
template <Int D>
PURE HOSTDEV auto
QuadraticQuadrilateral<D>::meanChordLength() const noexcept -> Float
  requires(D == 2)
{
...
QuadraticQuadrilateral<D>::intersect(Ray2 const ray,
...
template <Int D>
PURE HOSTDEV constexpr auto
QuadraticQuadrilateral<D>::hasSelfIntersection() const noexcept -> bool
  requires(D == 2)
{
...
template <Int D>
HOSTDEV constexpr auto
QuadraticQuadrilateral<D>::hasSelfIntersection(Point2 * const buffer) const noexcept
    -> bool
  requires(D == 2)
{
