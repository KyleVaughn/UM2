...
auto triangleArea(Point2<T> const & p0,
                  Point2<T> const & p1,
...
template <typename T>
UM2_PURE UM2_HOSTDEV constexpr
auto quadrilateralArea(Point2<T> const & p0,
                       Point2<T> const & p1,
                       Point2<T> const & p2,
...
UM2_PURE UM2_HOSTDEV constexpr
auto area(LinearPolygon<N, 2, T> const & poly) noexcept -> T
{
    if constexpr (N == 3) {
...
UM2_PURE UM2_HOSTDEV constexpr
auto triangleCentroid(Point<D, T> const & p0,
                      Point<D, T> const & p1,
...
template <typename T>
UM2_PURE UM2_HOSTDEV constexpr
auto quadrilateralCentroid(Point2<T> const & p0,
                           Point2<T> const & p1,
                           Point2<T> const & p2,
...
template <len_t N, typename T>
UM2_PURE UM2_HOSTDEV constexpr
auto centroid(LinearPolygon<N, 2, T> const & poly) noexcept -> Point2<T> 
{
    if constexpr (N == 3) {
...
template <typename T>
UM2_PURE UM2_HOSTDEV constexpr
auto centroid(Triangle<3, T> const & tri) noexcept -> Point3<T>
{
