...
//
// Morton sorted. The small cases are faster (5.4%, 11.5%), but he large case is slower (-11.9%).
// (3.89 ms, 33.9 ms, 26295 ms, didn't run)
//
...
BENCHMARK_TEMPLATE_DEFINE_F(Tri6Fixture, smallPin_f32i32, float, int32_t)(benchmark::State & state)
{
  using T = float;
...
BENCHMARK_TEMPLATE_DEFINE_F(Tri6Fixture, bigPin_f32i32, float, int32_t)(benchmark::State & state)
{
  using T = float;
...
BENCHMARK_TEMPLATE_DEFINE_F(Tri6Fixture, smallLattice_f32i32, float, int32_t)(benchmark::State & state)
{
  using T = float;
...
BENCHMARK_TEMPLATE_DEFINE_F(Tri6Fixture, bigLattice_f32i32, float, int32_t)(benchmark::State & state)
{
  using T = float;
...
BENCHMARK_REGISTER_F(Tri6Fixture, smallPin_f32i32)
    ->Unit(benchmark::kMillisecond);

BENCHMARK_REGISTER_F(Tri6Fixture, bigPin_f32i32)
    ->Unit(benchmark::kMillisecond);

BENCHMARK_REGISTER_F(Tri6Fixture, smallLattice_f32i32)
    ->Unit(benchmark::kMillisecond);

BENCHMARK_REGISTER_F(Tri6Fixture, bigLattice_f32i32)
    ->Unit(benchmark::kMillisecond);
