...
main() -> int
{
  ...
  um2::Material gap;
  gap.setName("Gap");
  // "Helium with nominal density" (pg. 22).
  // He at 565 K and 2250 psia, according to NIST has a density of 0.012768 g/cm^3.
  ...
  um2::gmsh::model::mesh::setGlobalMeshSize(pitch / 24);
  // double const target_kn = 12.0;
  // um2::gmsh::model::mesh::setMeshFieldFromKnudsenNumber(2,
  //     model.materials(), target_kn);
