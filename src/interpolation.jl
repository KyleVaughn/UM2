...
function (hex20::QuadraticHexahedron)(r, s, t)
    ...
    return Point(((1 - ξ)*(1 - η)*(1 - ζ)*(-2 - ξ - η - ζ)/8)hex20[ 1] +
                 ...
                 ((1 - ξ)*(1 + η)*(1 + ζ)*(-2 - ξ + η + ζ)/8)hex20[ 8] +
                            ...
                            ((1 - ξ^2)*(1 - η  )*(1 + ζ  )/4)hex20[13] +
                            ((1 + ξ  )*(1 - η^2)*(1 + ζ  )/4)hex20[14] +
                            ((1 - ξ^2)*(1 + η  )*(1 + ζ  )/4)hex20[15] +
                            ((1 - ξ  )*(1 - η^2)*(1 + ζ  )/4)hex20[16] +
                            ((1 - ξ  )*(1 - η  )*(1 - ζ^2)/4)hex20[17] +
                            ((1 + ξ  )*(1 - η  )*(1 - ζ^2)/4)hex20[18] +
                            ((1 + ξ  )*(1 + η  )*(1 - ζ^2)/4)hex20[19] +
                            ((1 - ξ  )*(1 + η  )*(1 - ζ^2)/4)hex20[20] )
end
