# Constants used in more than 1 file, or very important constants

# Point_2D
# ---------------------------------------------------------------------------------------------------
# Distance between points to be considered different
...
#     v
#      v⃗
const LineSegment_2D_parallel_θ = π/20000 # ≈ 0.01°
# Fudge factor for segment intersections near vertices
const LineSegment_2D_ϵ = 5e-6

# QuadraticSegment_2D
# ---------------------------------------------------------------------------------------------------
# Fudge factor for segment intersections near vertices
const QuadraticSegment_2D_ϵ = 5e-6
