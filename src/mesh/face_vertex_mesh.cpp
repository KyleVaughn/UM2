...
template <I P, I N>
void
FaceVertexMesh<P, N>::flipFace(I i) noexcept
{
  if constexpr (P == 1 && N == 3) {
...
FaceVertexMesh<P, N>::populateVF() noexcept
{
  ...
  I const num_vertices = numVertices();
  I const num_faces = numFaces();
...
{
  I constexpr edges_per_face = QuadraticFVM<N>::Face::numEdges();
  for (I i = 0; i < mesh.numFaces(); ++i) {
    auto const face = mesh.getFace(i);
    for (I j = 0; j < edges_per_face; ++j) {
      auto const edge = face.getEdge(j);
...
////template <I N, std::floating_point T, std::signed_integral I>
////void
////intersectFixedBuffer(Ray2<F> const & ray, PlanarLinearPolygonMesh<N, T, I> const &
/// mesh, /                     F * const intersections, I * const n) noexcept
////{
////  I nintersect = 0;
////#if UM2_ENABLE_ASSERTS
////  I const n0 = *n;
////#endif
////  I constexpr edges_per_face = PlanarQuadraticPolygonMesh<N, T, I>::Face::numEdges();
////  for (I i = 0; i < mesh.numFaces(); ++i) {
////    auto const face = mesh.getFace(i);
////    for (I j = 0; j < edges_per_face; ++j) {
////      auto const edge = face.getEdge(j);
...
////                     F * const intersections, I * const n) noexcept
////{
////  I nintersect = 0;
////#if UM2_ENABLE_ASSERTS
////  I const n0 = *n;
