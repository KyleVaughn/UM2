...
function RGBA(color::NTuple{3, UInt8})
    return RGBA(color..., UInt8(255))
end

function RGBA(color::NTuple{4, I}) where {I <: Integer}
    return RGBA(UInt8.(color)...)
end

function RGBA(r::T, g::T, b::T, a::T) where {T <: AbstractFloat}
    return RGBA(UInt8(r * 255), UInt8(g * 255), UInt8(b * 255), UInt8(a * 255))
end
...
const color_names = Dict{String, NTuple{4, UInt8}}(
