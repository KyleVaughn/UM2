...
{
  using named_color = std::pair<String, Color>;
  ...
  Vector<named_color> const named_colors = {
  ...
  const auto * const it = std::lower_bound(named_colors.cbegin(), named_colors.cend(),
