...
function gauss_legendre_quadrature(::Val{1})
    weights = @SVector [1.0]
    r = @SVector [0.5]
    return weights, r
end

function gauss_legendre_quadrature(::Val{2})
    weights = @SVector [0.5, 0.5]
    r = @SVector [0.21132486540518713, 0.7886751345948129]
    return weights, r
end

function gauss_legendre_quadrature(::Val{3})
    weights = @SVector [0.2777777777777776,
                        0.4444444444444444,
                        0.2777777777777776]
    r = @SVector [0.1127016653792583,
                  0.5,
                  0.8872983346207417]
    return weights, r
end

function gauss_legendre_quadrature(::Val{4})
    weights = @SVector [
                  0.17392742256872684,
                  0.3260725774312732,
                  0.3260725774312732,
...
function gauss_legendre_quadrature(::Val{5})
    weights = @SVector [
                  0.1184634425280945,
                  0.23931433524968326,
                  0.28444444444444444,
...
function gauss_legendre_quadrature(::Val{10})
    weights = @SVector [
                  0.03333567215434387,
                  0.07472567457529025,
                  0.1095431812579911,
...
function gauss_legendre_quadrature(::Val{15})
    weights = @SVector [
...
function gauss_legendre_quadrature(::Val{20})
    weights = @SVector [
                  0.00880700356957606,
                  0.02030071490019347,
                  0.03133602416705453,
...
# end
# 
# function gauss_legendre_quadrature(tri::Triangle6_2D, ::Val{27})
#     # P11. 0 negative weights, 3 points outside of the triangle
#     w = @SVector [0.00046350316448,
#           0.00046350316448,
#           0.00046350316448,
#           0.03857476745740,
#           0.03857476745740,
...
# end
# 
# function gauss_legendre_quadrature(tri::Triangle6_2D, ::Val{48})
#     # P15. 0 negative weights, 9 points outside of the triangle
#     w = @SVector [0.000958437821425,
#           0.000958437821425,
#           0.000958437821425,
#           0.022124513635550,
#           0.022124513635550,
...
# end
# 
# function gauss_legendre_quadrature(tri::Triangle6_2D, ::Val{79})
#     # P20. 3 negative weights, 9 points outside of the triangle
#     w = @SVector [+0.016528527770800,
#           +0.000433509592831,
#           +0.000433509592831,
#           +0.000433509592831,
#           +0.005830026358200,
