...
main() -> int
{
  ...
  // Cross sections
  um2::Vector<double> const uo2_sigma_t = {2.12450e-01, 3.55470e-01, 4.85540e-01, 5.59400e-01,
  ...
  // Make the geometry
  um2::gmsh::model::occ::addCylindricalPin2D({0.7 * pin_pitch, 0.9 * pin_pitch}, {radius}, {uo2});
