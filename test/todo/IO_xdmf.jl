...
using HDF5
@testset "XDMF" begin @testset "c5g7 pin - triangles" begin
    ...
    mesh = UnstructuredMesh_2D{Float64, UInt64}(points = ref_points,
                                                faces = ref_faces,
    ...
    redirect_stdout(devnull) do
        return write_xdmf_2d("c5g7_UO2_pin.xdmf", mesh)
    end
    # check xdmf
    ...
    ref_material_IDs = [i <= 7 ? 0 : 1 for i in 1:22]
