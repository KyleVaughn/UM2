@testset "Polytope" begin
    ...
    @testset "Polytope{1}" begin
        @testset "LineSegment{2}" begin for T in Floats
            P₁ = Point{2, T}(1, 0)
            P₂ = Point{2, T}(2, 0)
            l = LineSegment(P₁, P₂)
            @test l.vertices[1] == P₁
        ...
        @testset "QuadraticSegment{2}" begin for T in Floats
            # Constructor
            P₁ = Point{2, T}(0, 0)
            P₂ = Point{2, T}(2, 0)
            P₃ = Point{2, T}(1, 1)
        ...
        @testset "QuadraticSegment{3}" begin for T in Floats
            # Constructor
            P₁ = Point{3, T}(0, 0, 0)
            P₂ = Point{3, T}(0, 2, 0)
            P₃ = Point{3, T}(0, 1, 1)
    ...
    @testset "Polytope{2}" begin
        @testset "Triangle{2}" begin for T in Floats
            P₁ = Point{2, T}(0, 0)
            P₂ = Point{2, T}(1, 0)
            P₃ = Point{2, T}(0, 1)
            tri = Triangle(P₁, P₂, P₃)
        ...
        @testset "Triangle{3}" begin for T in Floats
            P₁ = Point{3, T}(0, 0, 0)
            P₂ = Point{3, T}(0, 1, 0)
            P₃ = Point{3, T}(0, 0, 1)
            tri = Triangle(P₁, P₂, P₃)
        ...
        @testset "Quadrilateral{2}" begin for T in Floats
            P₁ = Point{2, T}(0, 0)
            P₂ = Point{2, T}(1, 0)
            P₃ = Point{2, T}(1, 1)
            P₄ = Point{2, T}(0, 1)
        ...
        @testset "Quadrilateral{3}" begin for T in Floats
            P₁ = Point{3, T}(0, 0, 0)
            P₂ = Point{3, T}(0, 1, 0)
            P₃ = Point{3, T}(0, 1, 1)
            P₄ = Point{3, T}(0, 0, 1)
        ...
        @testset "QuadraticTriangle{2}" begin for T in Floats
            P₁ = Point{2, T}(0, 0)
            P₂ = Point{2, T}(1, 0)
            P₃ = Point{2, T}(1, 1)
            P₄ = Point{2, T}(1 // 2, 0)
        ...
        @testset "QuadraticQuadrilateral{2}" begin for T in Floats
            P₁ = Point{2, T}(0, 0)
            P₂ = Point{2, T}(1, 0)
            P₃ = Point{2, T}(1, 1)
            P₄ = Point{2, T}(0, 1)
        ...
        @testset "QuadraticTriangle{3}" begin for T in Floats
            P₁ = Point{3, T}(0, 0, 0)
            P₂ = Point{3, T}(0, 1, 0)
            P₃ = Point{3, T}(0, 1, 1)
            P₄ = Point{3, T}(0, 1 // 2, 0)
        ...
        @testset "QuadraticQuadrilateral{3}" begin for T in Floats
            P₁ = Point{3, T}(0, 0, 0)
            P₂ = Point{3, T}(0, 1, 0)
            P₃ = Point{3, T}(0, 1, 1)
            P₄ = Point{3, T}(0, 0, 1)
