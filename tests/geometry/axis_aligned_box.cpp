...
TEST_CASE(intersect_ray)
{
  ...
  auto const ray0 = um2::Ray2(um2::Point2(half, static_cast<F>(0)), um2::Vec2<F>(0, 1));
  ...
  auto const ray1 = um2::Ray<2>(um2::Point2(-half, half * 3), um2::Vec2<F>(1, 0));
  ...
  auto const ray3 =
      um2::Ray<2>(um2::Point2(half, half * 3), um2::Vec2<F>(1, 1).normalized());
