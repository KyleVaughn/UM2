...
TEST_SUITE(RegularPartition)
{
  ...
  TEST_HOSTDEV(boundingBox, 1, 1, D, P);
  if constexpr (D == 2) {
    TEST_HOSTDEV(getBox_and_getChild, 1, 1, P);
  }
}
