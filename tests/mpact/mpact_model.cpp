...
TEST_CASE(addRectangularPinMesh)
{
  ...
  ASSERT(aabb.minima().isApprox(um2::Point2F(0, 0)));
  ASSERT(aabb.maxima().isApprox(um2::Point2F(2, 1)));
...
TEST_CASE(addAssembly_2d)
{
  ...
  um2::RectilinearGrid1F const & grid = assembly.grid();
...
TEST_CASE(importCoarseCellMeshes)
{
  ...
  ASSERT(tri_mesh.getVertex(0).isApprox(um2::Point2F(0, 0)));
  ASSERT(tri_mesh.getVertex(1).isApprox(um2::Point2F(1, 0)));
  ASSERT(tri_mesh.getVertex(2).isApprox(um2::Point2F(1, 1)));
  ASSERT(tri_mesh.getVertex(3).isApprox(um2::Point2F(0, 1)));
  ...
  ASSERT(tri_mesh1.getVertex(0).isApprox(um2::Point2F(0, 0)));
  ASSERT(tri_mesh1.getVertex(1).isApprox(um2::Point2F(0, 1)));
  ASSERT(tri_mesh1.getVertex(2).isApprox(um2::Point2F(1, 0)));
  ASSERT(tri_mesh1.getVertex(3).isApprox(um2::Point2F(1, 1)));
  ...
  ASSERT(quad_mesh.getVertex(0).isApprox(um2::Point2F(1, 0)));
  ASSERT(quad_mesh.getVertex(1).isApprox(um2::Point2F(0, 0)));
  ASSERT(quad_mesh.getVertex(2).isApprox(um2::Point2F(1, 1)));
  ASSERT(quad_mesh.getVertex(3).isApprox(um2::Point2F(0, 1)));
...
TEST_CASE(operator_PolytopeSoup)
{
  ...
  ASSERT(soup.getVertex(5).isApprox(um2::Point3F(1, 1, 0)));
  ASSERT(soup.getVertex(6).isApprox(um2::Point3F(2, 0, 0)));
  ASSERT(soup.getVertex(7).isApprox(um2::Point3F(2, 1, 0)));

  ASSERT(soup.getVertex(8).isApprox(um2::Point3F(1, 1, 0)));
  ASSERT(soup.getVertex(9).isApprox(um2::Point3F(0, 1, 0)));
  ASSERT(soup.getVertex(10).isApprox(um2::Point3F(1, 2, 0)));
  ASSERT(soup.getVertex(11).isApprox(um2::Point3F(0, 2, 0)));

  ASSERT(soup.getVertex(12).isApprox(um2::Point3F(2, 1, 0)));
  ASSERT(soup.getVertex(13).isApprox(um2::Point3F(1, 1, 0)));
  ASSERT(soup.getVertex(14).isApprox(um2::Point3F(2, 2, 0)));
  ASSERT(soup.getVertex(15).isApprox(um2::Point3F(1, 2, 0)));
